...
const ChatAssistant = ({ onOpenStateChange }: ChatAssistantProps) => {
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                <div
                    className="mb-4 w-full sm:w-[380px] h-[500px] bg-background/80 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300 pointer-events-auto"
                    style={{
